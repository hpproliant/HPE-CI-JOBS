...
function run_redfish_test {
    ...
    openstack baremetal node set --driver-info deploy_kernel=http://169.16.1.54:9999/fedora_30_03_20.kernel --driver-info deploy_ramdisk=http://169.16.1.54:9999/fedora_30_03_20.initramfs --driver-info bootloader=http://169.16.1.54:9999/ir-deploy-redfish.efiboot --instance-info image_source=http://169.16.1.54:9999/rhel_7.6-uefi.img --instance-info image_checksum=fd9b31d6b754b078166387c86e7fd8ce --instance-info capabilities='{"boot_mode": "uefi"}' --property capabilities='boot_mode:uefi' $ironic_node
