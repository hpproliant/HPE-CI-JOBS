...
function install_packages {
    ...
    sudo apt -y install apache2 isc-dhcp-server ovmf webfs socat vlan liberasurecode-dev libssl-dev python3-pip python3-setuptools
...
function run_stack {
    ...
    wget http://169.16.1.54:9999/fedora-wd-uefi.img
    wget http://169.16.1.54:9999/ir-deploy-ilo.iso
